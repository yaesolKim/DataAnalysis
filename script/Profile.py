...
def plot_motion_diff(y1t, y1e, y1r, y2t, y2e, y2r, y3t, y3e, y3r, y4t, y4e, y4r):
    fig, axes = plt.subplots(nrows=2, ncols=2, figsize=(10, 8))

    diff = [y1e[i]-y1r[i] for i in range(0, len(y1t))]
    axes[0, 0].plot(y1t, diff, label='motion diff')
    axes[0,0].set_ylim(-0.15, 0.15)
    axes[0, 0].legend()
    axes[0, 0].set_title('K = 20')

    diff = [y2e[i] - y2r[i] for i in range(0, len(y2t))]
    axes[0, 1].plot(y2t, diff, label='motion diff')
    axes[0, 1].set_ylim(-0.15, 0.15)
    axes[0, 1].legend()
    axes[0, 1].set_title('K = 50')

    diff = [y3e[i] - y3r[i] for i in range(0, len(y3t))]
    axes[1, 0].plot(y3t, diff, label='motion diff')
    axes[1, 0].set_ylim(-0.15, 0.15)
    axes[1, 0].legend()
    axes[1, 0].set_title('K = 60')

    diff = [y4e[i] - y4r[i] for i in range(0, len(y4t))]
    axes[1, 1].plot(y4t, diff, label='motion diff')
...
def plot_force_diff(y1t, y1e, y1r, y2t, y2e, y2r, y3t, y3e, y3r, y4t, y4e, y4r):
    fig, axes = plt.subplots(nrows=2, ncols=2, figsize=(10, 8))
...
#plot_motion_diff(Data_20._time, Data_20._eth_pose, Data_20._rem_pose, Data_50._time, Data_50._eth_pose, Data_50._rem_pose, Data_60._time, Data_60._eth_pose, Data_60._rem_pose, Data_Ke._time, Data_Ke._eth_pose, Data_Ke._rem_pose)
plot_force_diff(Data_20._time, Data_20._eth_force, Data_20._rem_force, Data_50._time, Data_50._eth_force, Data_50._rem_force, Data_60._time, Data_60._eth_force, Data_60._rem_force, Data_Ke._time, Data_Ke._eth_force, Data_Ke._rem_force)
